...
public class BinaryAPIControllerTest {
    ...
    @Test
    public void blankParams() throws Exception {
    ...
    public void stringParams() throws Exception {
        this.mvc.perform(get("/add_json").param("operand1","Hello").param("operand2","World"))//.andDo(print())
                .andExpect(status().isOk())
    ...
    @Test
    public void negativeParams() throws Exception {
        this.mvc.perform(get("/add_json").param("operand1","-1001").param("operand2","-11"))//.andDo(print())
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.operand1").value(0))
                .andExpect(MockMvcResultMatchers.jsonPath("$.operand2").value(0))
                .andExpect(MockMvcResultMatchers.jsonPath("$.result").value(0))
